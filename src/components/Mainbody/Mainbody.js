  ...
  return (
    <div className='bg-[#000000]'>
      ...
      <h1 className='lg:text-4xl text-2xl font-bold px-3 lg:px-0 mb-2'>Discover The Secret of Blood Pressure 911 </h1>
        ...
        <a href="https://www.bloodpressure911.health/">
        ...
        <button className='px-3 py-2 lg:text-lg mx-10 lg:mx-0 rounded-lg mb-10 bg-[#0f8548] leading-normal  hover:bg-[#0f8548]'><a className='mb-2' href="https://www.bloodpressure911.health/">Click Here and Access The Official Website Now</a></button>
        <a href="https://www.bloodpressure911.health/">
        ...
        <div className='lg:text-lg text-sm lg:pt-32 pt-10'>
            <a href="https://www.bloodpressure911.health/">Terms of Use </a>|
            <a href="https://www.bloodpressure911.health/"> Privacy Policy</a>
        </div>
    </div>
    </div>
  )
