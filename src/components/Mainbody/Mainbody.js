    ...
    <div style={{
      ...
      <h1 className='lg:text-4xl text-2xl font-bold px-3 lg:px-0 mb-2'>Discover The Secret of Blood Pressure 911 </h1>
        ...
        <div className='text-center  lg:mt-20 mt-8 '>
          ...
          <p className='lg:text-5xl text-3xl font-bold  '>SALE</p>
          {/* <p className='text-xl'>Up To 50% Off</p> */}
        </div>
        <a className='bannerbody-img' href="https://www.r3hlvtrk.com/3J67C/7ZSXMBL/">
        ...
        <button className='px-3 py-2 lg:text-lg mx-10 lg:mx-0 rounded-lg mb-10 bg-[#0f8548] leading-normal  hover:bg-[#0f8548]'><a className='mb-2' href="https://www.r3hlvtrk.com/3J67C/7ZSXMBL/">Click Here and Access The Official Website Now</a></button>
        <a href="https://www.r3hlvtrk.com/3J67C/7ZSXMBL/">
