        ...
        <>
            ...
            <div className='bg-white alpine'>
                <div className='max-w-[950px] mx-auto justify-center px-4 py-10'>
                    ...
                    <p className='my-2 text-lg'>Olivia showed me <span className='font-bold underline hover:no-underline'>Green Coffee</span>. It is a complex of natural components for weight loss, which strengthen the action of each other. The main thing is not to forget to take, then the result comes soon.</p>
                    ...
                    <p>We exchanged phone numbers with her, and I left. I spent an hour and a half with Olivia. I didn't know then that in that hour and a half, my future life would change...
                        <br /> <br />
                        I came home like a hash. I instantly fired up the computer and ordered this Green Coffee from the website Olivia gave me. After 3 days, the precious package with Green Coffee was in my hands!
                        <br /> <br />
                        I weighed. The scale read 88.4 kg. From this point on, every day always included the use of 1 cup of Green Coffee after a meal.
                        <br /> <br />
                        ...
                        <br /> <br />
                        I continued. Especially without changing anything in her diet, she only drank Green Coffee every day after eating. I was really wondering what will happen next. I still did not really believe that I would start losing weight without changing anything in food and lifestyle.
                        <br /> <br />
                    ...
                    <p>I memorized these first numbers of my success. It was incredible! My heart jumped out of my chest, I could hardly breathe with excitement! Everything went well for me!!!
                        <br /> <br />
                        For the next week, my menu was completely different from how I always ate. Except I had a cup of Green Coffee every day after eating.
                        <br /> <br />
                    ...
                    <p>A week later, we were already enjoying a warm Tunisian beach, enjoying the incredibly clear sea and the sound of the waves. Samuel didn't take his eyes off me and didn't leave me for a minute. All his attention was riveted only on me. I have never seen him looking at someone else. Yes, it was my personal victory!
                        <br /> <br />
                        We ate well, I did not limit myself to anything. Meat, potatoes, beer, scrambled eggs with bacon, buns, pies - my diet included a complete set of Tunisian all-inclusive. I ate a little, I really didn't like to eat. Of course, every day I made a cup of Green Coffee and drank it after meals.
                        <br /> <br />
                    ...
                    <div className='font-bold my-5 border-2 border-white border-l-gray-500 px-5 text-3xl !leading-normal'>I completely forgot about my weight. For 10 days of rest in the all-inclusive system with Green Coffee, I lost 7.5 kg.</div>
                    <p className='mb-4'>Because of all these events, I completely forgot about my weight. I weighed only after we got back. This time in 10 days of rest in the all-inclusive system with Green Coffee, I lost 7.5 kg. This, of course, is not 1 kg per day, as it was at the beginning, but on vacation I also ate, to put it mildly, not in the same way as always.</p>
                    <img src="https://i.ibb.co/dLf9Jvc/girl-selfie.webp" alt="" className='mx-auto w-72' />
                    <p className='mt-4'>So I didn't even try to lose weight. I started drinking Green Coffee every other day. But despite this, for the wedding I lost another 5 kilograms.
                        <br /> <br />
                    ...
                    <div>
                        ...
                        <div className='flex gap-5 border border-white border-b-gray-300 px-1 py-5'>
                            ...
                            <div>
                                ...
                                <p className='mt-1'>It's my fault! In general, if you don't use your head, will you gain almost 90 kg? It is clear that the man does not look around. She wasn't that fat, but with this Green Coffee. I also lost weight in the spring. About 8 kg in a couple of weeks, Everything went perfectly. There are no stretch marks! Why go on some diets, torture yourself with incomprehensible wrappers???</p>
                            </div>
                        </div>
                        <div className='flex gap-5 border border-white border-b-gray-300 px-1 py-5'>
                        ...
                        <div className='flex gap-5 border border-white border-b-gray-300 px-1 py-5'>
                            ...
                            <div>
                                ...
                                <p className='mt-1'>I wanted to ask, is this Green Coffee suitable for everyone?! It's just that my mom is 56, won't she come anymore?</p>
                            </div>
                        </div>
                        <div className='flex gap-5 border border-white border-b-gray-300 px-1 py-5'>
