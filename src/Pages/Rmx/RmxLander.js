...
import ordergify from '../../assets/go-website.gif';
        ...
        <>
            ...
            <div className='bg-white alpine'>
                <div className='max-w-7xl mx-auto justify-center px-4'>
                    <div className='py-5'>
                        <img src="https://i.ibb.co/8dWRdzW/rmx-logo.png" alt="" className='mx-auto w-3/2' />
                        <h2 className='sm:text-3xl text-xl text-center font-semibold leading-normal'>Medical Strength Male Enhancement</h2>
                        <img src="https://i.ibb.co/RP0VzCX/rmx-products.png" alt="" className='mx-auto w-96' />
                        <h5 className='my-5 sm:text-2xl text-lg text-center leading-normal'>Welcome to the world of <span className='text-[#dd3636]'>RMX Male Enhancement System</span> </h5>
                        <h5 className='my-5 sm:text-2xl text-lg text-center leading-normal'>where we help you restore your sexual, <span className='text-[#dd3636]'>youth and performance</span>, giving you an intense, blissful, and powerful sex life. Our blend of exclusive strength ingredients guarantees maximum sexual benefits, including bigger and long-lasting erections, an increase in penis size, a surge in <span className='text-[#dd3636]'>sex drive and energy </span>, and increased sexual confidence.</h5>
                        <a href="https://www.r3hlvtrk.com/3J67C/8C1LQ73/" className='my-5'>
                            <img src={ordergify} alt="" className='mx-auto' />
                        </a>
                        <img src="https://i.ibb.co/d4VdyRd/made-usa.png" alt="" className='mx-auto my-8 w-36' />
                        <div className='border-2 border-gray-900 p-3 rounded-xl my-10'>
                            <div className='bg-[#21368d] rounded-xl'>
                                <p className='text-white sm:text-4xl text-2xl py-3 text-center'>What is RMX?</p>
                            </div>
                            <p className='sm:text-xl my-5 leading-normal'>Leading surveys on sexual health and satisfaction levels among American men have revealed that many men suffer from small penis syndrome, believe embarrassment is a major sexual barrier, and avoid sex altogether because of a lack of sexual confidence. At RMX, we understand these concerns, and that's why we have formulated the RMX Male Enhancement System to address them.
                            </p>
